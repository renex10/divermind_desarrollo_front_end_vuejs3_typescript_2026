...
import { useNotificationStore } from '@/store/notificationStore' // ✨ IMPORTAR
...
// ✨ OBTENER STORE DE NOTIFICACIONES
...
// ✨ FUNCIÓN MEJORADA CON NOTIFICACIÓN TOAST
function addStep() {
  ...
  notificationStore.success(
    `Paso "${stepToAdd.action}" añadido correctamente`,
    '✅ Paso Añadido',
    4000
  )
...
// ✨ FUNCIÓN ELIMINAR CON NOTIFICACIÓN
...
// ✨ FUNCIÓN DRAG END CON NOTIFICACIÓN
function onDragEnd(event: any) {
  ...
  // ✨ DISPARAR NOTIFICACIÓN SI HUBO CAMBIO
