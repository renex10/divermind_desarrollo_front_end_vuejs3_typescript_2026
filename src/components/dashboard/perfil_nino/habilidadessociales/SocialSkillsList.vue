<template>
  <div class="social-skills-list flex flex-col h-full">
...
import Paginator from '@/components/utils/paginator.vue'; // ✅ Importar el componente
import { 
  EyeIcon, 
...
defineProps<{
  skills: SocialSkill[],
  loading: boolean,
  totalItems: number,    // Necesario para el paginador
  currentPage: number,   // Necesario para el paginador
  pageSize: number       // Necesario para el paginador
}>();
...
defineEmits<{
  ...
  (e: 'page-change', page: number): void       // Evento del paginador
  (e: 'page-size-change', size: number): void  // Evento del paginador
}>();
