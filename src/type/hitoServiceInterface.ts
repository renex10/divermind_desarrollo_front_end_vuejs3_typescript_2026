...
/**
 * Define la estructura mínima de datos de Chart.js para un gráfico de dona o línea.
 * Se utiliza para tipar las propiedades computadas en MilestonesMetrics.vue.
 */
export interface ChartData {
    labels: string[];
    datasets: {
        label?: string; // Solo necesario para gráficos de línea
        data: number[];
        backgroundColor?: string[]; // Para gráficos de dona/pie
        borderColor?: string; // Para gráficos de línea
...
export interface Milestone {
    ...
    // ✅ AJUSTE: El backend devuelve esto como string ("string" en Swagger)
    previous_records_count: string; 
